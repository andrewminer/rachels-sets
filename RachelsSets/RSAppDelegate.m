...
@property (nonatomic, strong) RSGameViewController *gameViewController;
...
- (BOOL) application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions {
    [NSNumber seedRandomizer];

    self.gameViewController = [[RSGameViewController alloc] initWithGame:[[RSGame alloc] init]];
    self.gameViewController.record = [RSGameRecord new];
